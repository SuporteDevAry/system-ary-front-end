...
export function EditarContato() {
  ...
  const contatoForUpdate: IListContatos = location.state?.contatoForUpdate;
  ...
  const handleCreate = async () => {
    ...
    try {
      contatoContext.updateContato(contatoForUpdate.cli_codigo,
      ...
      toast.success(`Contato ${formData.cli_codigo} ${formData.sequencia}, foi alterado com sucesso!`);
      navigate("/contatos");
