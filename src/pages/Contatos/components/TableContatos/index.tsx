...
export function TableContatos() {
  ...
  const [objClienteContato, setObjClienteContato] = useState<TClienteContato[]>(
    []
  );
    ...
    <>
      ...
      <TableContainer component={Paper}>
        ...
        >
          ...
          <TableBody>
            {objClienteContato.map((cliContato: TClienteContato) => (
              <TableRow
                key={cliContato.id}
                sx={{
              ...
              >
                ...
                <TableCell align="left">{cliContato.cli_nome}</TableCell>
                <TableCell align="left">{cliContato.cnpj}</TableCell>
                <TableCell align="left">{cliContato.cidade}</TableCell>
                <TableCell align="left">{cliContato.uf}</TableCell>
                <TableCell align="left">{cliContato.sequencia}</TableCell>
                <TableCell align="left">{cliContato.nome}</TableCell>
                <TableCell>
                  <SButtonContainer>
                    <SButtonEdit
                      onClick={() => handleUpdateContato(cliContato)}
                    >
                      Editar
                    </SButtonEdit>
                    <SButtonDelete
