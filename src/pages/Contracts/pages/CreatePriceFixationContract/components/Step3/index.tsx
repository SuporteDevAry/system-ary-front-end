...
export const Step3: React.FC<StepProps> = ({
  ...
  return (
    <SContainer id={id}>
      ...
      {/*
        Contrato "a fixar": este "Preço" é só uma referência inicial opcional
        (não conta como fixação de mercado) — o preço "de verdade" só existe
        depois que ao menos uma fixação for lançada no histórico.
      */}
      <CustomInput
        type="text"
        name="price"
        label={`Preço de Referência em ${formData.type_currency}:`}
        $labelPosition="top"
