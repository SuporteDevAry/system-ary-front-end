...
// "price" aqui é só um preço de referência inicial opcional (não conta como
// fixação de mercado — ver Step3/index.tsx e o backend GrainFixationContractController).
