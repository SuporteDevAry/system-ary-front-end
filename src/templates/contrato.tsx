...
const ContratoTemplate: React.FC<ContratoTemplateProps> = ({
    ...
    let quantity_aux = formData.quantity;
    let formattedQtd = quantity_aux; // Carlão - Retirei .toLocaleString() estava colocando , no campo;

    let qtd_int_extenso = formData.quantity.replace(/[.]/g, "");

    console.log("modeSave", modeSave);
    console.log("quantity_aux", quantity_aux);
    console.log("formattedQtd", formattedQtd);
    console.log("qtd_int_extenso", qtd_int_extenso);

    const qtde_extenso = Extenso(qtd_int_extenso);
