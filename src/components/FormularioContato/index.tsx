...
import { ButtonCancelar, ButtonGravar, BoxContainer, SFormContainer, SCli_codigoInput, SSequenciaInput, SGrupoInput, SNomeInput, SCargoInput, SEmailInput, STelefoneInput, SCelularInput } from "./styles";
...
export function FormularioContato({titleText, data, onChange, onHandleCreate}:IFormularioContatosProps) {
    ...
    return(
        ...
        <SFormContainer>
          ...
          <BoxContainer>
            <ButtonCancelar onClick={() => navigate("/contatos")}> Cancelar</ButtonCancelar>
